...
<%session.invalidate(); %>
	...
	<div id="site_div">
		...
		<br/>
                <br/><span><b><h1>Connect Globe</h1></b></font></span>
		</div>
		<div id="menu">
		<ul>
                    <li><a href="#">Home</a></li>							
...
<div id="main">
	...
	<div class="prev_but_center">
		...
		<p><a href="#">Vivamus id lobortis nisi. Duis semper porta justo, vel sodales velit vehicula vel. </a><br/>
                    Donec non vulputate odio. Quisque tellus augue, tristique vel lobortis ut, convallis vel est. Nam
                    vel congue lectus. Suspendisse ullamcorper odio et leo congue eu semper </p>
            <div class="read"><a href="#">read more</a></div>
            </div>
	</div>			
	</div>
